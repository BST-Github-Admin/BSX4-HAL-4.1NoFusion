...
#define SENSOR_TYPE_WRIST_TILT_GESTURE              (26U)   /**< wrist tilt gesture sensor*/
/*! @} */
...
typedef enum sensor_identifier_type
{
    ...
    BSX_SENSOR_ID_WRIST_TILT_DETECTOR           = BSX_SENSOR_ID_STANDARD_START + SENSOR_TYPE_WRIST_TILT_GESTURE, /**< SENSOR_TYPE_WRIST_TILT_GESTURE  */
    ...
    BSX_SENSOR_ID_WRIST_TILT_DETECTOR_WAKEUP    = BSX_SENSOR_ID_WAKEUP_START + BSX_SENSOR_ID_WRIST_TILT_DETECTOR , /**< SENSOR_TYPE_WRIST_TILT_GESTURE */
